...
window = tk.Tk() #creates the frame

canvas = tk.Canvas(window, height=800, width=800, bg='white') #creates a canvas widget, which can be used for drawing lines and shapes
create_grid(canvas)
canvas.pack(expand=True) #packing widgets places them on the board

make_red(window, canvas)
